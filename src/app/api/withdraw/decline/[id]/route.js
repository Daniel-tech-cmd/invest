...
<html lang="en">
  <head>
    ...
    <title>Withdrawal Declined - GoldGroveco</title>
    ...
    <div class="email-wrapper">
      <div class="email-container">
        ...
        <div class="content">
          ...
          <p class="message">
            We regret to inform you that your withdrawal request could not be processed at this time. This may be due to insufficient balance, verification requirements, or other technical reasons.
          </p>
          ...
          <p class="message" style="margin-bottom: 15px;">
            You can review your account balance and try submitting a new withdrawal request or reach out to our support team for assistance.
          </p>
